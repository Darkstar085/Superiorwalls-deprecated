...
open class SettingsActivity : BaseThemedActivity<Preferences>() {
    ...
    private val preferencesListener = SharedPreferences.OnSharedPreferenceChangeListener { _, prefKey ->
        when (prefKey) {
            Preferences.CURRENT_THEME -> { setDefaultDashboardTheme(); onThemeChanged() }
            ...
            SuperiorwallsTheme(
                ...
                SettingsScreen(
                    ...
                    onRequestNotificationsPermission = {
                        (this@SettingsActivity as? BasePermissionsRequestActivity<*>)?.requestNotificationsPermission()
                    },
                )
            }
        }
