...
import com.sipun.superiorwalls.library.extensions.resources.getDarker
import com.sipun.superiorwalls.library.extensions.resources.getLighter
import com.sipun.superiorwalls.library.extensions.resources.isDark
import com.sipun.superiorwalls.library.extensions.resources.withMinAlpha

internal const val MAX_PALETTE_COLORS = 6
...
val Palette.bestSwatches: List<Palette.Swatch>
    get() {
        ...
        val maxSize =
            if (distinctSwatches.size <= MAX_PALETTE_COLORS) distinctSwatches.size
