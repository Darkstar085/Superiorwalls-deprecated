...
import com.sipun.superiorwalls.library.ui.widgets.SuperiorwallsBottomNavigationView
...
abstract class BaseSystemUIVisibilityActivity<out P : Preferences> :
    ...
    val bottomNavigation: SuperiorwallsBottomNavigationView? by findView(R.id.bottom_navigation)
