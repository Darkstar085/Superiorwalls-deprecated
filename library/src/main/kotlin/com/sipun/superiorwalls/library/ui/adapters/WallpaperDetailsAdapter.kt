...
import com.sipun.superiorwalls.library.ui.viewholders.SectionHeaderViewHolder
import com.sipun.superiorwalls.library.ui.viewholders.WallpaperDetailViewHolder
import com.sipun.superiorwalls.library.ui.viewholders.WallpaperPaletteColorViewHolder
...
class WallpaperDetailsAdapter(
    ...
    override fun getRowSpan(
        ...
        relativePosition: Int,
        absolutePosition: Int
    ): Int = if (section == 1) 1 else (MAX_PALETTE_COLORS / 2.0).roundToInt()
}
